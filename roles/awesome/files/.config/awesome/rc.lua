...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "d", function () lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous nonempty", group = "tag"}),
    awful.key({ modkey, "Shift" }, "n", function () lain.util.tag_view_nonempty(1) end,
              {description = "view  previous nonempty", group = "tag"}),
    ...
    -- Clipmenud
    awful.key({ modkey }, "l", function () os.execute("clipmenu") end,
